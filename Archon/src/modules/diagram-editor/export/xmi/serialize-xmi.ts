import type { DiagramType, SoarDiagram } from '@/core/types'
...
export function supportsXmi(diagram: Pick<SoarDiagram, 'type' | 'engine'>): boolean {
  return (
...
export function serializeXmi(diagram: SoarDiagram): string {
